...
public interface LoginApi {
    ...
    default Mono<ResponseEntity<Map<String, String>>> loginPost(@ApiParam(value = "" ) @RequestHeader(value="Authorization", required=false) String authHeader) {
...
//        }
    ...
    default Mono<ResponseEntity<User>> updateRole(@PathVariable int id, @RequestBody String role) {
    	return Mono.just(new ResponseEntity<>(HttpStatus.ACCEPTED));
    }
